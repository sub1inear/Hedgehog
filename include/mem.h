...
#define hhg_malloc(size) \
    hhg_debug_malloc(size, (hhg_mem_alloc_loc_t) { __FILE__, __func__, __LINE__ })
#define hhg_realloc(ptr, size) \
    hhg_debug_realloc(ptr, size, (hhg_mem_alloc_loc_t) { __FILE__, __func__, __LINE__ })
#define hhg_free(ptr) \
...
#define hhg_arena_malloc(arena, size) \
    hhg_debug_arena_malloc(arena, size, (hhg_mem_alloc_loc_t) { __FILE__, __func__, __LINE__ })
